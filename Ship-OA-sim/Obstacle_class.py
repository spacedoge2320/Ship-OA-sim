...
class square_obstacle(object):
    def __init__(self, initial_pos_scaled,heading,obstacle_color):
        ...
        [lat_pose, ax_pose] = [initial_pos_scaled, heading]
    ...
    def scale_and_rotate_polygons(self):
        self.scaled_pose = [self.phys_status['pose'][0], self.phys_status['pose'][1]]
        rotated_points = []
...
class wall(object):
    def __init__(self, initial_pos_scaled,heading,obstacle_color):
        ...
        # base values
        self.output_polygon = None
        self.obstacle_points = [(8, 0.5), (8, -0.5), (-8, -0.5), (-8, 0.5)]
        self.obstacle_color = obstacle_color
